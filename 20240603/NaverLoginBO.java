...
//	네이버 로그인 API 등록시 발급받은 Client ID, Client Secret과 Callback URL을 입력한다.
	private final static String CLIENT_ID = "420oOp8sbpR3US480o1Q";
	private final static String CLIENT_SECRET = "YrY9rW4ics";
	private final static String REDIRECT_URI = "http://localhost:9090/springWEB_NaverLoginAPI/callback";
